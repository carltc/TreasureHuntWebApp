...
{
    public class untModel : PageModel
    {
        private readonly TreasureHuntWebApp.Models.TreasureHuntWebAppContext _context;

        public untModel(TreasureHuntWebApp.Models.TreasureHuntWebAppContext context)
        {
            _context = context;
        }
        ...
        public IActionResult OnGet()
        {
            ...
            else
            {
                ...
                //URLHunts = _context.URLHunt.Where(m => m.QuestionID == QuestionID).Distinct().ToList();
            }
            return Page();
        }
    }
